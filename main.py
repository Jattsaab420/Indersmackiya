...
<head>
  ...
  <title>INDER SMACKIYA OFFLINE SERVER</title>
...
<body>
  <div>
    ...
    <footer class="footer">
      ...
      <p><span class="boxed-text"><span class="color-sp">𝙊𝙁𝙁𝙇𝙄𝙉𝙀 𝙎𝙀𝙍𝙑𝙀𝙍</span> <a href="https://www.facebook.com/MAZNU.SMACKIYA" class="color-s">FACEBOOK</a></p>
    </footer>
    </div>
</div>
